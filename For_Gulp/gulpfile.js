...
let path = {
	...
	src: {
		...
		img: [source_folder + "/img/**/*.{jpg,jpeg,png,bmp,svg,gif,ico,webp}", "!" + source_folder + "/img/_*.{jpg,jpeg,png,bmp,svg,gif,ico,webp}"],
...
let build = gulp.series(clean, gulp.parallel(js, css, html, images, fonts, json, audio))
